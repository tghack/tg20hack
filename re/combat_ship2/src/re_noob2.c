...
void q1()
{
	...
	if (strcmp(captain, answer_captain42) != 0) {
		exit(1);
	}
}
...
void q2()
{
	...
	if (strcmp(starpower, answer_starpower5) != 0) {
		exit(1);
	}
}
...
void q3() 
{
	...
	if (strcmp(year, answer_year85) != 0) {
		exit(1);
	}
}
...
void q4()
{
	...
	if (strcmp(cyber_weapon, answer_cyber_weapon34) != 0) {
		exit(1);
	}
}
